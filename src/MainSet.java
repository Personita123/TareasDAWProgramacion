...
public class MainSet {
    ...
    //Lunas para Jupiter
        ...
        System.out.println("Todos los planetas del conjunto \n");
        ...
        System.out.println("\nIntento añadir pluton de nuevo mismo tipo\n");
        ...
        System.out.println("\nIntento añadir pluton de nuevo diferente tipo\n");
        ...
        //Intersección
        System.out.println("\nIntersección\n");//Devuelve Mercurio,Venus,Tierra,Marte y jupiter que son los que comparten los dos
        ...
        planetas2.add(Te);
        planetas2.add(BenDover);
        System.out.println("\nDiferencia\n"); //Devuelve solo Bigo,te y BenDover que son los diferentes
